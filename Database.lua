...
function Database:ApplyMigrations(profile)
    ...
    if IS_FOREVER then
        ...
        profile.gamePadCameraYawMultiplier = Clamp(tonumber(profile.gamePadCameraYawMultiplier) or 1.0, 1, 4)
        profile.gamePadCameraPitchMultiplier = Clamp(tonumber(profile.gamePadCameraPitchMultiplier) or 1.0, 1, 4)
