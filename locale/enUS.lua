...
L["FOREVER_GROUND_EFFECT_OVERRIDE_DESC"] = "Off by default. When enabled, the addon first captures the client's current raw ground-effect values so enabling it does not change your graphics, then manages the three controls below."
